"""
Resolution Override Tool - Manage viewport settings for RetroArch ROM configs.

This package provides tools for parsing DAT files (FinalBurn Neo, MAME) and
creating/updating RetroArch configuration files with custom viewport resolutions.
...
__version__ = "1.0.0"
__author__ = "Resolution Override Tool Contributors"
